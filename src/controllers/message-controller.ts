  ...
  constructor(
    ...
    this.modules = new Map([
      [
        ...
        new Command(
          userModule,
          userModule.createProfileMessage,
          false,
          BotConstants.COMMANDS.DESC.USER
        ),
      ],
      [
        BotConstants.COMMANDS.PING,
        new Command(
          this,
          this.handleMessage,
          false,
          BotConstants.COMMANDS.DESC.PING
        ),
      ],
      [
      ...
      [
        ...
        new Command(
          ...
          this.handleMessage,
          false,
          BotConstants.COMMANDS.DESC.STOCK
        ),
      ],
      [
        BotConstants.COMMANDS.HELP,
        new Command(
          this,
          this.handleMessage,
          false,
          BotConstants.COMMANDS.DESC.HELP
        ),
      ],
      [
        ...
        new Command(
          ...
          db.createTables,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.GENERATE_DB
        ),
      ],
      [
        ...
        new Command(
          managementModule,
          managementModule.addAdminChannel,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.ADD_ADMIN_CHANNEL
        ),
      ],
      [
        ...
        new Command(
          managementModule,
          managementModule.deleteAdminChannel,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.DELETE_ADMIN_CHANNEL
        ),
      ],
      [
        ...
        new Command(
          managementModule,
          managementModule.addUser,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.ADD_USER
        ),
      ],
      [
        ...
        new Command(
          managementModule,
          managementModule.addRole,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.ADD_ROLE
        ),
      ],
      [
        ...
        new Command(
          managementModule,
          managementModule.addUserRole,
          true,
          BotConstants.COMMANDS.DESC.ADMIN.ADD_USER_ROLE
        ),
      ],
    ]);
  }
    ...
    if (message.content.startsWith(this.prefix + BotConstants.COMMANDS.HELP)) {
      ...
      this.managementModule.isUserAdmin(message.author.id).then((res) => {
        ...
        profileEmbed
          ...
          .addFields(
            {
              name: BotConstants.INFO.COMMAND_LIST.COMMAND_TITLE,
              value: keyList,
              inline: true,
            },
            {
              name: BotConstants.INFO.COMMAND_LIST.COMMAND_DESC,
              value: descList,
              inline: true,
            }
          )
          .setTimestamp()
          .setFooter(
            BotConstants.INFO.COMMAND_LIST.FOOTER,
            BotConstants.URL.LOGO
          );
